---
description: 在 TronSave 上购买能量和带宽的所有方式——网站、Telegram、ZapBuy 和自动购买。
---
...
{% hint style="info" %}
初次使用？最快完成首次购买的方式见[快速开始](../../getting-started/quickstart.md)。如需了解各订单类型之间的概念差异，请参阅[订单类型](../../concepts/order-types.md)。
{% endhint %}
...
➡️ [**在网站购买**](on-the-website/) — [普通](on-the-website/normal-order.md) · [挂单](on-the-website/pending-order.md) · [智能](on-the-website/smart-order.md)

### 在 Telegram 购买

通过 TronSave Telegram 机器人，使用你的**内部账户**余额进行租赁。创建账户、充值 TRX，然后在聊天中购买。在 Telegram 上租赁只能使用内部账户，因此请先确保其有足够余额。

➡️ [**在 Telegram 购买**](on-telegram/)
...
{% hint style="info" %}
正在构建集成？开发者可以通过 API 以编程方式购买——请参阅[开发者快速开始](../../developers/quickstart.md)和 [API 参考](../../developers/api-reference/)。
{% endhint %}

## 后续步骤

* [订单类型](../../concepts/order-types.md) · [能量和带宽](../../concepts/energy-and-bandwidth.md) · [定价与 APY](../../concepts/pricing-and-apy.md)
* [在网站购买](on-the-website/) · [在 Telegram 购买](on-telegram/) · [ZapBuy](zapbuy.md) · [自动购买](auto-buy.md)
