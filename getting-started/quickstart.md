...
{% hint style="success" %}
完成了。要了解不同的购买方式（Normal、Pending、Smart、ZapBuy、Auto Buy），请参见[购买能量与带宽](../guides/buy/README.md)。
{% endhint %}
...
* [开发者快速开始](../developers/quickstart.md) · [身份认证](../developers/authentication.md) · [API 参考](../developers/api-reference/README.md)
